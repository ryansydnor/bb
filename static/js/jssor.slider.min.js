...
init_sliders = (function() {
    ...
    var sliders = [].slice.call(document.getElementsByClassName('image-slider'));
    var jssor_sliders = [];
    [].forEach.call(sliders, function(el){
    	slider = new $JssorSlider$(el, slider_options);
    	jssor_sliders.push(slider);
    });

    function ScaleSliders() {
    	[].forEach.call(jssor_sliders, function(slider) {
    ...
    ScaleSliders();
    $Jssor$.$AddEvent(window, "load", ScaleSliders);
    $Jssor$.$AddEvent(window, "resize", ScaleSliders);
    $Jssor$.$AddEvent(window, "orientationchange", ScaleSliders);
})();